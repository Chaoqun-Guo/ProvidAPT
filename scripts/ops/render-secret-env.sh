...
PROVIDAPT_API_AUTH_KEYS=CHANGE_ME_ADMIN_API_KEY
PROVIDAPT_POLICY_API_KEY=CHANGE_ME_POLICY_API_KEY
PROVIDAPT_SIEM_TOKEN=CHANGE_ME_SIEM_TOKEN
PROVIDAPT_LICENSE_SIGNING_KEY=CHANGE_ME_LICENSE_SIGNING_KEY_OR_USE_PUBLIC_KEY_PATH
