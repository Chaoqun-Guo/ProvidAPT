...
TASKS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "needs_evidence",
        "local": True,
        "summary": "Collect accelerated noisy-host soak evidence with CPU, memory, disk, and dropped-event budgets.",
        "acceptance": "soak-readiness passes against dense short-cycle VM samples.",
        "command": "make soak-sample SOAK_SAMPLE_COUNT=6 SOAK_SAMPLE_INTERVAL_SECONDS=10 ... && make soak-readiness SOAK_SAMPLES=... SOAK_MIN_HOURS=0.05",
        "external_dependency": "Current VM/API access and representative noisy-host activity.",
    },
    {
...
EVIDENCE_MAP = {
    ...
    "soak-accelerated": ["soak_readiness"],
