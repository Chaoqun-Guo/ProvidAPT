...
open-source-development-backlog:
	python3 scripts/release/open-source-development-backlog.py $(if $(LOCAL_ONLY),--local-only) $(if $(PHASE),--phase "$(PHASE)") --out-json "$(or $(OUT_DIR),build/open-source-readiness)/open-source-development-backlog.json" --out-md "$(or $(OUT_DIR),build/open-source-readiness)/open-source-development-backlog.md"
