...
For production, replace every operator-specific value in `examples/config/providapt.production.yaml`, including TLS paths, CORS origins, SIEM token, and upgrade signatures.
