...
- Run `providaptctl -release-check -config <release-config> -release-evidence docs/project/release-evidence-v1.2.2.md -release-check-out build/release-readiness.md`
