...
This record captures the local P0 closure for a controlled release-candidate handoff. GitHub Actions evidence is intentionally excluded from this run by release-owner instruction and must be attached before public publication.
...
| --- | --- | --- | --- | --- |
| GitHub Actions evidence is intentionally excluded from this P0 run | Public release cannot rely on this record alone | Attach authenticated GitHub Actions evidence before public publication | Release Engineering | Before public publication |
