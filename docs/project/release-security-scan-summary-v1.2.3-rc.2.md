...
- Generated at: `2026-08-28T03:37:53Z`
- Gate status: `pass`
...
| --- | --- | ---: | ---: |
| `govulncheck` | `pass` | 0 | 6.100 |
| `grype_source` | `pass` | 0 | 3.995 |
| `trivy_fs` | `pass` | 0 | 6.067 |
...
| `govulncheck_json` | `present` | 541636 |
| `grype_source` | `present` | 7233 |
| `trivy_fs` | `present` | 23091 |
