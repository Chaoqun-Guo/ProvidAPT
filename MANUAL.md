...
```go
// File: userspace/pkg/pipeline/pipeline.go
...
```go
// File: userspace/pkg/hwaccel/nvme.go — RocksDBConfig()
...
```go
// File: userspace/pkg/pipeline/batchwriter.go
